...
static const extFloat80_t fx80_zero = packToExtF80(0, 0x0000, U64(0x0000000000000000));
static const extFloat80_t fx80_one  = packToExtF80(0, 0x3fff, U64(0x8000000000000000));
static const extFloat80_t fx80_ninf = packToExtF80(1, 0x7fff, U64(0x8000000000000000));
static const extFloat80_t fx80_inan = packToExtF80(1, 0x7fff, U64(0xC000000000000000));
...
INLINE bool floatx80_is_quiet_nan(extFloat80_t a)
{
	...
	aLow = a.signif & ~U64(0x4000000000000000);
	return
