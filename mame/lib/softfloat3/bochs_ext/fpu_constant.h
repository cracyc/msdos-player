...
#define floatx80_one packFloatx80(0, 0x3fff, uint64_t(0x8000000000000000))

#define float128_one packFloat128(uint64_t(0x3fff000000000000), uint64_t(0x0000000000000000))
